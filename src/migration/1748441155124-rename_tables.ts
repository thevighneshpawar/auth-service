...
export class RenameTables1748441155124 implements MigrationInterface {
    name = 'RenameTables1748441155124'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.renameTable('refresh_tokens', 'refreshToken')
    }
}
